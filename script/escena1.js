...
class BasicCharacterController {
  ...
  _LoadModels() {
    ...
    var modelPlayerPath = '';
    if(jugador==1){
      pathPlayer = './resources/jugador1/';
      modelPlayerPath = 'Exo_Gray.fbx';
    }
    if(jugador==2){
      pathPlayer = './resources/jugador2/';
      modelPlayerPath = 'Ch45_nonPBR.fbx';
    }
    loader.setPath(pathPlayer);
    loader.load(modelPlayerPath, (fbx) => {
